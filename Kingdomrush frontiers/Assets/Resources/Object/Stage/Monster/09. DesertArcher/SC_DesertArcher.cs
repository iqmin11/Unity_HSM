...
public class SC_DesertArcher : SC_BaseMonster, ISoundManager
{
    ...
    {
        Data.SetData(MonsterEnum.DesertArcher);
    }
    ...
    public void InitSoundManager()
    {
        ...
        SoundManagerInst = new GameObject("DesertArcher_SoundManager");

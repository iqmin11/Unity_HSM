...
sealed public class SC_MagicBullet : SC_DirectBullet
{
    override protected void Awake()
    {
        ...
        {
            Animators.Add(Resources.Load<AnimatorOverrideController>("Object/Stage/Tower/MagicTower/AnimationClip/Bullet/AC_MagicBullet"));
            Animators.Add(Resources.Load<AnimatorOverrideController>("Object/Stage/Tower/MagicTower/AnimationClip/Bullet/AC_ArcMageBullet"));
        }
